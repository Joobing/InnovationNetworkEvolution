...
link1995<-link2012[,c(1,2)]
link1996<-link2013[,c(1,2)]
link1997<-link2014[,c(1,2)]
link1998<-link2015[,c(1,2)]
link1999<-link2016[,c(1,2)]
#[!link2016$category %in% c("actor","actress","producer","archive_footage", "self"),c(1,2)]
...
indv1<-indv[indv$year %in% c(2012,2013,2014),]
...
director<-list(aggregate(director ~ nconst, indv1, mean), aggregate(director ~ nconst, indv2, mean), aggregate(director ~ nconst, indv3, mean))            
composer<-list(aggregate(composer ~ nconst, indv1, mean), aggregate(composer ~ nconst, indv2, mean), aggregate(composer ~ nconst, indv3, mean))            
editor<-list(aggregate(editor ~ nconst, indv1, mean), aggregate(editor ~ nconst, indv2, mean), aggregate(editor ~ nconst, indv3, mean))            
cinematographer<-list(aggregate(cinematographer ~ nconst, indv1, mean), aggregate(cinematographer ~ nconst, indv2, mean), aggregate(cinematographer ~ nconst, indv3, mean))            
production_designer<-list(aggregate(production_designer ~ nconst, indv1, mean), aggregate(production_designer ~ nconst, indv2, mean), aggregate(production_designer ~ nconst, indv3, mean))            
writer<-list(aggregate(writer ~ nconst, indv1, mean), aggregate(writer ~ nconst, indv2, mean), aggregate(writer ~ nconst, indv3, mean))            
...
cinematographer<-sienain(cinematographer, "nconst", "cinematographer")
writer<-sienain(writer, "nconst", "writer")
editor<-sienain(editor, "nconst", "editor")
director<-sienain(director, "nconst", "director")
production_designer<-sienain(production_designer, "nconst", "production_designer")
composer<-sienain(composer, "nconst", "composer")
...
cinematographer         <- varCovar(cinematographer, nodeSet="crew")
composer         <- varCovar(composer, nodeSet="crew")
production_designer         <- varCovar(production_designer, nodeSet="crew")
writer         <- varCovar(writer, nodeSet="crew")
director         <- varCovar(director, nodeSet="crew")
editor         <- varCovar(editor, nodeSet="crew")
...
bipData <- sienaDataCreate(bip, creativity,  focus_genres, focus_roles, start_year, #uni,#focus_type, focus_role, conf_role, #crtv_cov, comedy, 
                           director, writer, editor, cinematographer, production_designer, composer,
...
# bipEffects <- includeEffects(bipEffects, egoX, name="bip", interaction1="director", nodeSet="crew")
# bipEffects <- includeEffects(bipEffects, egoX, name="bip", interaction1="writer", nodeSet="crew")
# bipEffects <- includeEffects(bipEffects, egoX, name="bip", interaction1="editor", nodeSet="crew")
# bipEffects <- includeEffects(bipEffects, egoX, name="bip", interaction1="production_designer", nodeSet="crew")
# bipEffects <- includeEffects(bipEffects, egoX, name="bip", interaction1="composer", nodeSet="crew")
# bipEffects <- includeEffects(bipEffects, egoX, name="bip", interaction1="cinematographer", nodeSet="crew")
